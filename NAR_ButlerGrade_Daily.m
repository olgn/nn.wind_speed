...
BG_y_2012 = mat2gray(BG_y_2012);
 ...
 BG_y_2012 = imfilter(BG_y_2012,f);
...
title( 'BUTLER GRADE NARNET RESULTS, DAILY DATA, 2012' );
...
axis tight; %set axis
legend( 'TARGET', 'OUTPUT' );
title( 'BUTLER GRADE NARNET RESULTS, DAILY DATA, 2013' );
%%
figure(3);
hold on;
...
axis tight;
legend('TARGET','OUTPUT');
title('BUTLER GRADE DETAIL, DAILY DATA, 2013');