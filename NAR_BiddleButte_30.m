...
lag = 15; %number of 30 min samples lag
graphend = lag+1;
...
title( 'BIDDLE BUTTE NARNET RESULTS, 30 MINUTE DATA, 2012' );
...
RMSEtest = sqrt(perform(net,Ts_2013,Y_2013)) %mean square error
...
axis tight; %set axis
legend( 'TARGET', 'OUTPUT' );
title( 'BIDDLE BUTTE NARNET RESULTS, 30 MINUTE DATA, 2013' );
%%
figure(3);
hold on;
...
axis tight;
legend('TARGET','OUTPUT');
title('BIDDLE BUTTE DETAIL, 30 MINUTE DATA, 2013');