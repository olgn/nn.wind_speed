...
[BB_x_2012, BG_y_2012, BG_x_2012, BG_y_2012] = Wind_PreProcessing(data_2012);
...
lag = 4; %number of 60 min samples lag
graphend = lag+1;
...
title( 'BUTLER GRADE NARNET RESULTS, 60 MINUTE DATA, 2012' );
...
axis tight; %set axis
legend( 'TARGET', 'OUTPUT' );
title( 'BUTLER GRADE NARNET RESULTS, 60 MINUTE DATA, 2013' );
%%
figure(3);
hold on;
...
axis tight;
legend('TARGET','OUTPUT');
title('BUTLER GRADE DETAIL, 60 MINUTE DATA, 2013');